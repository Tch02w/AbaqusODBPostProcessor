...
from . import app_final_v3_base as _previous
...
class MainWindow(_previous.MainWindow):
    def __init__(self) -> None:
        self.state_path = project_root() / "project_state.json"
    ...
    def _run_finished(self, outputs: list[str]) -> None:
        root = str(Path(outputs[0]).parents[2] if outputs else project_root() / "runs")
