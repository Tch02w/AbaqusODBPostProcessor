"""Compatibility entry for final validation paths and GIF duration checks."""
...
base_path = Path(__file__).with_name("validate_output_base.py")
...
for marker in (
    ...
    if marker not in source:
        raise RuntimeError(f"Validation v2 patch failed: {marker}")
