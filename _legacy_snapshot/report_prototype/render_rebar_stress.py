...
END_STEP = "V20D"
INSTANCE_NAME = "MR-1"
SEQUENCE_NAME = "REBAR_LONG_S11_UNDEFORMED"
...
LOG_PATH = os.path.join(OUTPUT_DIR, "rebar", "rebar_render.log")
...
with open(LOG_PATH, "w", encoding="utf-8") as stream:
    stream.write("Longitudinal rebar S11 rendering started\n")

viewport = session.Viewport(name="Longitudinal Rebar S11", origin=(0, 0), width=180, height=120)
