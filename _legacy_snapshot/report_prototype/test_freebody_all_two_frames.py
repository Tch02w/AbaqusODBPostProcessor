...
viewport = session.Viewport(name="FreeBody ALL Test", origin=(0, 0), width=160, height=100)
...
viewport.odbDisplay.setValues(viewCut=ON, viewCutNames=("TEST_ALL_XY",))
...
path = os.path.abspath(os.path.join(os.getcwd(), "abaqus_odb_prototype", "freebody_all_two_frames.csv"))
start = time.time()
