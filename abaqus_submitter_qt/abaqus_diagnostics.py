...
This module is deliberately independent from legacy GUI globals.
...
try:
    from .ui_performance import measure_ui_callback
except ImportError:

    def measure_ui_callback(_name: str):
        """Return an empty context when Qt performance logging is disabled."""
        return nullcontext()
