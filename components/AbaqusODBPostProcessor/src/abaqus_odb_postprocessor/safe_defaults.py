"""GUI entry with safe root-key and retained-soil defaults."""
...
_base.MainWindow.columns[13] = "存留土体剖面集合"
...
def _populate_with_safe_defaults(self, scans):
    ...
    for row in self.row_widgets:
        ...
        soil = _exact(candidates, self.defaults.get("default_soil_set", "SET-SOIL_CUT"))
        if not soil:
