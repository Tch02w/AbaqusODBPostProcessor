"""Final worker with robust, incremental Y-Plane operation patches."""

from __future__ import print_function
import os, sys

candidates = [value for value in sys.argv if value.lower().replace("/", "\\").endswith("extract_job_final_v20.py")]
if not candidates: raise RuntimeError("Cannot locate extract_job_final_v20.py in argv")
...
source = source.replace("extract_job_final_v14.py", "extract_job_final_v20.py")
