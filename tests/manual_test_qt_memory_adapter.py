...
import abaqus_submitter_qt.memory_adapter as memory_adapter_module
from abaqus_submitter_qt.main import MainWindow
from abaqus_submitter_qt.memory_adapter import QtMemoryMonitorAdapter
...
def main() -> int:
    ...
    print("manual_test_qt_memory_adapter: OK")
    return 0
